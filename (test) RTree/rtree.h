...
#define  PAGE_SIZE    4096     // 100만개일 때 -b 10으로 줄거니까 <--------------------------------
...
{        
    RTREEMBR    mbr;
    struct _RTREENODE *child;    /* mbr id => child mbr (taetae) */
}RTREEBRANCH;
...
{
    int    count; /* Maybe this is a number of child branch (taetae) */
    int    level; /* 0 is leaf, others positive */
    RTREEBRANCH  branch[MAXCARD]; /* Mabye this is child MBRs of this Node (taetae) */      // branch 최대 개수 = 73
	//RTREEBRANCH  branch[4]; /* Mabye this is child MBRs of this Node (taetae) */
}RTREENODE;
